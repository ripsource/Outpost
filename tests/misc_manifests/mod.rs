...
pub struct RoyaltyConfig {
    ...
    pub permissioned_dapps: HashMap<ComponentAddress, ResourceAddress>,
...
pub fn create_outpost(
    ...
    let manifest = ManifestBuilder::new()
        .lock_fee_from_faucet()
        .call_method(component, "create_outpost", manifest_args!(user.account))
        .call_method(
            user.account,
            "deposit_batch",
            manifest_args!(ManifestExpression::EntireWorktop),
...
pub fn custom_royalty_config(
    ...
    limit_dapps: bool,
    permissioned_dapps: HashMap<ComponentAddress, ResourceAddress>,
    limit_buyers: bool,
